...
class KV(object):
    ...
    def Get(
        ...
        return grpc.experimental.unary_unary(
            request, target, '/kv.KV/Get', kv__pb2.GetRequest.SerializeToString,
            kv__pb2.GetResponse.FromString, options, channel_credentials, insecure,
    ...
    def Set(
            ...
            metadata=None):
        return grpc.experimental.unary_unary(
            request, target, '/kv.KV/Set', kv__pb2.SetRequest.SerializeToString,
            kv__pb2.SetResponse.FromString, options, channel_credentials, insecure,
            call_credentials, compression, wait_for_ready, timeout, metadata)
